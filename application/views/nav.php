...
<aside class="app-sidebar">
    <div class="app-sidebar__user"> 
        <center>
            <img class="app-sidebar__user-avatar" src="<?php echo $sesion['foto'];?>" alt="User Image" style="width: 100% ;height: 100%;">
            <div id="des-usuario">
            ...
            <nav id="sidebar">
                ...
                <ul class="navbar-nav theme-brand flex-row  text-center">
                    <li class="nav-item theme-logo">
                        <a href="index.html">
                            <img src="<?php echo base_url(); ?>template/assets/img/90x90.jpg" class="navbar-logo" alt="logo">
                        </a>
                    </li>
                    <li class="nav-item theme-text">
                        <a href="index.html" class="nav-link"> PROYECTO ADA </a>
                    </li>
                </ul>
                <!-- END Cabecera Azul -->
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    <!-- Ejemplo de Menú con 1 subnivel de manera desplegable
                    ...
                    Fin de Menú con 1 subnivel de manera desplegable-->

                    <li id="inicio" class="menu">
                        <a id="hinicio" href="<?= site_url('Corporacion') ?>" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-home"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path><polyline points="9 22 9 12 15 12 15 22"></polyline></svg>
                                <span>Inicio</span>
                            </div>
                    ...
                    <li id="genero" class="menu">
                        <a id="hgenero" href="<?= site_url('Corporacion/Genero') ?>" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li id="cargar-archivo" class="menu">
                        <a id="hcargar-archivo" href="<?= site_url('Corporacion/Cargar_Archivo') ?>" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-map"><polygon points="1 6 1 22 8 18 16 22 23 18 23 2 16 6 8 2 1 6"></polygon><line x1="8" y1="2" x2="8" y2="18"></line><line x1="16" y1="6" x2="16" y2="22"></line></svg>
