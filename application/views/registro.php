    ...
    <div class="container">
        ...
        <div class="container-fluid">
                        <form id="msform">
                            <!-- progressbar -->
                            <ul id="progressbar">
                                <li class="active" id="account"><strong>Datos del puesto</strong></li>
                                <li id="personal"><strong>Datos Personales</strong></li>
                                <li id="payment"><strong>Referencias Familiares</strong></li>
                                <li id="casi"><strong>Estudios Realizados</strong></li>
                                <li id="casi"><strong>Experiencias laborales</strong></li>
                                <li id="casi"><strong>Información de salud</strong></li>
                                <li id="casi"><strong>Gestión del puesto</strong></li>
                                <li id="confirm"><strong>Completo</strong></li>
                                    ...
                                    <fieldset>
                                        <div class="form-card">
                                            ...
                                            <div class="form-control">
                                                ...
                                                <input type="text" name="" id="centrolaboral" placeholder="Ingrese su centro de labores" autocomplete="off" /> 
                                            ...
                                            <div class="form-control">
                                                <label for="">2.- Razón Social</label>
                                                <input type="text" name="" id="razonsocial" placeholder="Ingrese su centro de labores" autocomplete="off" /> 
                                                <i class="fas fa-check-circle"></i>
                                                <i class="fas fa-exclamation-circle"></i>
                                                <small>Error Msg</small>
                                            </div>
                                            ...
                                            <div class="form-control">
                                                <label class="fieldlabels">3.- R.U.C</label>
                                                <input type="text" name="" id="ruc" placeholder="Ingrese su centro de labores" autocomplete="off" /> 
                                                <i class="fas fa-check-circle"></i>
                                                <i class="fas fa-exclamation-circle"></i>
                                                <small>Error Msg</small>
                                            </div>
                                            ...
                                            <div class="form-control">
                                                <label class="fieldlabels">4.- Dirección</label>
                                                <input type="text" name="" id="direc" placeholder="Ingrese su centro de labores" autocomplete="off" /> 
                                                <i class="fas fa-check-circle"></i>
                                                <i class="fas fa-exclamation-circle"></i>
                                                <small>Error Msg</small>
                                            </div>
                                            ...
                                            <div class="form-control">
                                                <label class="fieldlabels">5.-Fecha de Ingreso</label>
                                            ...
                                            <div class="form-control">
                                                <label class="fieldlabels">6.- Gerencia</label>
                                                <input type="text" name="" id="gerencia" placeholder="Ingrese su centro de labores" autocomplete="off" /> 
                                                <i class="fas fa-check-circle"></i>
                                                <i class="fas fa-exclamation-circle"></i>
                                                <small>Error Msg</small>
                                            </div>
                                            ...
                                            <div class="form-control">
                                                <label class="fieldlabels">7.- Área</label>
                                                <input type="text" name="" id="area" placeholder="Ingrese su centro de labores" autocomplete="off" /> 
                                                <i class="fas fa-check-circle"></i>
                                                <i class="fas fa-exclamation-circle"></i>
                                                <small>Error Msg</small>
                                            </div>
                                            ...
                                            <div class="form-control">
                                                <label class="fieldlabels">8.- Puesto al que ingresa</label>
                                                <input type="text" name="" id="puestoi" placeholder="Ingrese su centro de labores" autocomplete="off" /> 
                                                <i class="fas fa-check-circle"></i>
                                                <i class="fas fa-exclamation-circle"></i>
                                                <small>Error Msg</small>
                                            </div>
                                        ...
                                        <input type="button" name="next" class="next action-button" id="submit" value="Siguiente" />
